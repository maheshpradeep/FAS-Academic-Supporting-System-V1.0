...
public class calcusadapter extends RecyclerView.Adapter<calcusadapter.subViewHolder> {
    private Context context;
    private ArrayList<String> subcode, credits, results;

    public calcusadapter(Context context, ArrayList<String> subcode, ArrayList<String> credits,
    ...
    public subViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.cal_row, parent, false);
    ...
    public void onBindViewHolder(@NonNull subViewHolder holder,@SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context,calupdatesub.class);
