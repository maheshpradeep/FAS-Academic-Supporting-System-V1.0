...
public class calmain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add_button = findViewById(R.id.addsub_button);
        add_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(calmain.this, caladdsub.class);
                startActivity(intent);
            }
        });

        myDB = new caldatabase(calmain.this);
        Subcode = new ArrayList<>();
        Credits = new ArrayList<>();
        Results = new ArrayList<>();

        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        cusadapter = new calcusadapter(calmain.this, Subcode, Credits, Results);
